...
function Preview() {
  ...
  return <><div className="ui-preview-banner"><strong>FICTIONAL PREVIEW / 虚构示例 · 不调用业务 API</strong><a href="/admin/overview">Cancel / 返回管理（不启用）</a>{ui.message && <span role="status">{ui.message}</span>}</div>
