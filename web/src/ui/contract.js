...
export const SURFACES = ['admin.shell', 'admin.overview', 'admin.usage', 'admin.tasks', 'admin.models.providers', 'admin.models.calls', 'admin.models.risks', 'admin.models.transfer', 'admin.models.preview.controls', 'admin.models.editor.common', 'admin.models.editor.advanced', 'admin.settings.chat.title', 'admin.settings.chat.project', 'admin.settings.chat.process', 'admin.settings.appearance', 'admin.settings.remote', 'admin.settings.paths', 'admin.settings.network', 'admin.settings.startup', 'chat.chrome', 'chat.sidebar', 'chat.messages', 'chat.composer']
