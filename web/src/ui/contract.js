...
export const SURFACES = ['admin.shell', 'admin.overview', 'admin.settings.chat.title', 'admin.settings.appearance', 'admin.settings.remote', 'admin.settings.paths', 'admin.settings.network', 'admin.settings.startup', 'chat.chrome', 'chat.sidebar', 'chat.messages', 'chat.composer']
