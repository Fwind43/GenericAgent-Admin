...
export const THEMES = Object.freeze([
  ...
  },
  {
    ...
    icon: Sunset,
    label: { zh: '暖色', en: 'Warm' },
    description: { zh: '暖白纸感与柔和陶土点缀', en: 'Warm paper with restrained terracotta accents' },
    preview: ['#F4F0ED', '#EEE6E1', '#995D4D'],
    antdAlgorithm: 'default',
    antdToken: {
      colorBgBase: '#F4F0ED',
      colorTextBase: '#362F2B',
      colorBorder: '#DED3CB',
      colorPrimary: '#995D4D',
      colorSuccess: '#3D8B40',
      colorWarning: '#E68A00',
  ...
  },
  {
    ...
    antdToken: {
      ...
      colorError: '#C0392B',
      colorInfo: '#0F7291',
      colorBgContainer: '#D2E3CC',
      colorBgLayout: '#DCE9D7',
